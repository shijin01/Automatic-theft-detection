...
public class custom_3 extends BaseAdapter{
    ...
    public custom_3(Context applicationContext, ArrayList<String> a, ArrayList<String> b,ArrayList<String> c,ArrayList<String> d) {
